...
**Here's a tutorial if you want to change from email to local user:**
...
5. **Click on Permissions and add a couple of users to this share**
...
7. **Under Administration select SMB Test**
...
9. **Once you have successfully loaded your Samba Test go to Administration → External Storage**
...
6. Under Administration select smb test
...
8. Once you have successfully loaded your Samba Test go to Administration ---> External Storage

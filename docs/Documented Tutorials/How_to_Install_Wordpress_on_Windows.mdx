...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/0A03C_NlMy0?si=jCgCWR-WCJ1gE0cE"
...
Add it to the environment variable paths
...
6. Select OK
7. Select OK again
8. Then Select OK to close the system properties box
9. Close all PowerShell and Terminal Windows So these settings Save
...
*PHP.ini Settings*
    ...
    The next step is to uncomment the following lines by removing ';' before the lines. For example the ";extension_dir=ext" should become "extension_dir = ext".
...
[Wordpress Caddyfile](https://github.com/DevilsDesigns/Youtube-Docs/blob/453283b9d58d107f502bfb32653909e27ab62e6d/Caddy-Examples/Wordpress/Caddyfile)

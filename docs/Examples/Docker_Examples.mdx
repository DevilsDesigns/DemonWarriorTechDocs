...
description: Comprehensive collection of Docker Compose examples for self-hosting applications including Nextcloud, Jellyfin, Immich, PhotoPrism, and more
sidebar_position: 2
...
jellyfin:
  ...
  volumes:
    ...
    - type: bind
      ...
      target: /Home-Movies
    - type: bind
      source: J:/Anime #(PUT YOUR MEDIA DIRECTORIES FOLDER PATH HERE)
      target: /Anime
      read_only: true
...
services:
  front:
    ...
    environment:
      ...
      # - BACK_URL=back:5000 # Optional should not be changed unless you know what you're doing
    ports:
      - '9090:80'
    depends_on:
      - back
...
### Immich Example (Alternative Configuration)
